      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-4">
        ...
        <div>
          ...
          <form className="flex">
            ...
            <button
              type="submit"
              className="bg-black text-white py-3 px-6 rounded-r-md hover:text-gray-500 text-sm transition-all"
            >
              Subscribe
            </button>
          </form>
        ...
        <div>
          ...
          <p className="text-gray-800 flex items-center">
            Call Us  </p>
            <p>
            <FiPhone className="inline-block ml-2 mr-2" /> 0123-456-789
          </p>
        </div>
      </div>
      {/* footer bottom  */}
      <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6 text-center">
        <p className="text-gray-500 text-sm tracking-tighter ">@ 2025,EliteMart All Rights Reserved.</p>
      </div>
    </footer>
  );
};
